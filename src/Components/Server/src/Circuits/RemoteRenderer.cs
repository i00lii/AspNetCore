...
namespace Microsoft.AspNetCore.Components.Browser.Rendering
{
    internal class RemoteRenderer : Renderer
    {
        ...
        protected override Task UpdateDisplayAsync(in RenderBatch batch)
        {
            ...
            {
                return UpdateDisplayAsyncConnected(batchBytes);
            }
            else
            {
        ...
        private async Task UpdateDisplayAsyncConnected(byte[] batchBytes)
        {
            ...
            if (disconnectedBatchBytes != null)
            {
                ...
                await WriteBatchBytes(disconnectedBatchBytes);
            }

            await WriteBatchBytes(batchBytes);
        }
